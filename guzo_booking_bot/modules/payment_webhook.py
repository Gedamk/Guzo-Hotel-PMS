...
def stripe_webhook():
    ...
    if event["type"] == "payment_intent.succeeded":
        ...
        print(f"ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Stripe payment succeeded: {intent['id']}")
        ...
        intent = event["data"]["object"]
        print(f"ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Stripe payment failed: {intent['id']}")
...
def telebirr_webhook():
    try:
        ...
        print(f"ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Telebirr callback received: {ref}, status={status}")
        ...
        print(f"ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Telebirr webhook error: {e}")
...
def paypal_webhook():
    try:
        ...
        if event_type == "PAYMENT.SALE.COMPLETED":
            ...
            print(f"ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ PayPal payment completed: {sale['id']}")
            ...
            print("ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ PayPal payment denied.")

        return jsonify({"status": "ok"}), 200
    except Exception as e:
        print(f"ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ PayPal webhook error: {e}")
        return jsonify({"error": str(e)}), 400
