# guzo_backend/tests/test_telegram_bot.py
import unittest
from unittest.mock import AsyncMock, MagicMock, patch
from guzo_backend.modules import telegram_bot

class TestTelegramBot(unittest.IsolatedAsyncioTestCase):

    @patch("guzo_backend.modules.telegram_bot.handle_booking")  # <-- patch the import inside telegram_bot
