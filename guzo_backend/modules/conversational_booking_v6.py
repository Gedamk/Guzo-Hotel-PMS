...
from guzo_backend.modules.email_sender import send_email as send_confirmation_email
from guzo_backend.modules.google_sheets import init_client, log_booking_to_sheet
